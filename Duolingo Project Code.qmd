...
#Curious if there's any patterns in how these folks use it rather than others. #Notice from the histogram that users trail off as days increases.
...
#Number of of Countries by User 
duodata <- duodata |> 
  group_by(user) |> 
