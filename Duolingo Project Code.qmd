...
duodata$color <- mycolors[ as.numeric(duodata$hc_cluster) ]

#Plot the 3rd PCA dimension, with labels (little harder to read)
plot3d(x = duodata$pca_dim1, 
       y = duodata$pca_dim2, 
       z = duodata$pca_dim3,
       col = duodata$color, 
       type = 's', 
